...
function TableGiangVien() {
    ...
    const DATA = [
        {
            hoTenGV: "Mã Trường Thành",
            MSCB: "002937",
            hocVi: "Tiến sĩ",
            emailGV: "abcxyz@ctu.edu.vn",
            sdtGV: "0999999999",
        },
        {
            hoTenGV: "Võ Trí Thức",
            MSCB: "002483",
            hocVi: "Nghiên cứu sinh",
            emailGV: "abcxyz@ctu.edu.vn",
            sdtGV: "0999999999",
        },
        {
            hoTenGV: "Trần Nguyễn Minh Thư",
            MSCB: "002635",
            hocVi: "Tiến sĩ",
            emailGV: "abcxyz@ctu.edu.vn",
            sdtGV: "0999999999",
        ...
        {
            hoTenGV: "Phạm Nguyên Khang",
            MSCB: "001348",
            hocVi: "Phó Giáo Sư - Tiến sĩ",
            emailGV: "abcxyz@ctu.edu.vn",
            sdtGV: "0999999999",
        },
        {
            hoTenGV: "Lê Quyết Thắng",
            MSCB: "000509",
            hocVi: "Tiến sĩ",
            emailGV: "abcxyz@ctu.edu.vn",
            sdtGV: "0999999999",
    ...
    function handleFilters() {
        const data = DATA.filter(
            (item) => giangVien.Name === "" || item.hoTenGV === giangVien.Name
        );
        setTableData(data);
    }
