...
function TableDeTai() {
    ...
    const DATA = [
        ...
        },
        {
            ...
            noiDungBaoCao:
                "Quản trị Token là nền tảng của nền Kinh tế Token (Tokenomics). Quản trị Token gồm 2 nội dung chính: (1) Khái niệm Token trên mạng Web3 kết hợp Blockchain. (2) Nguyên lý vận hành Token như tiền ảo hoặc tài sản. (3) Đánh giá tưu nhược của Token.",
            baoCaoVien: "Đỗ Thanh Nghị",
            ngayBaoCao: "07/6/2024",
            diaDiem: "Trường CNTT-TT",
            soLuong: ">30",
        ...
        },
        {
            ...
            tenChuyenDe:
                "Tổng quan về ung thư vú, ứng dụng các mô hình mạng học sâu trong phát hiện và phân loại ung thư vú",
            noiDungBaoCao:
        ...
        },
        {
            ...
            tenChuyenDe:
                "An efficient framework with self-attention mechanism and Deep Convolutional Generative Adversarial Network for breast cancer classification",
            noiDungBaoCao:
        ...
        },
        {
            ...
            tenChuyenDe:
                "Một cách thức tổ chức thi chung trên Moodle cho học phần có nhiều giảng viên giảng dạy",
            noiDungBaoCao:
                "Báo cáo này trình bày cách thức tổ chức thi chung cho học phần có nhiều giảng viên giảng dạy trong học kỳ. Các nôi dung báo cáo bao gồm: cách tổ chức ngân hàng câu hỏi, ra đề theo ma trận đề thi, tổ chức phòng thi trực tuyến trên moodle, công tác tổ chức và quản lý đợt thi.",
            baoCaoVien: "Ngô Bá Hùng",
            ngayBaoCao: "07/6/2024",
            diaDiem: "Trường CNTT-TT",
            soLuong: ">30",
        ...
        },
        {
            ...
            tenChuyenDe:
                "Một thuật toán mở rộng để sinh tập dữ liệu kiểm thử sử dụng phương pháp chia để trị để phân tích giá trị biên và phân vùng tương đương",
            noiDungBaoCao:
