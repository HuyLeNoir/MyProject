...
function TableDeTai() {
    ...
    const DATA = [
        {
            maDeTai: "1",
            tenDeTai:
                "Sàng lọc, tuyển chọn vi khuẩn nội sinh ở cây dược liệu, ứng dụng hỗ trợ điều trị các bệnh lý liên quan hội chứng chuyển hóa",
    ...
    const Theads = [{size: "w-[40%]", fieldName: "Tên đề tài"}, {size: "", fieldName: "Cấp đề tài"}, {size: "", fieldName: "Ngày thực hiện"}, {size: "", fieldName: "Chủ nhiệm"}, {size: "", fieldName: "Lĩnh vực"}];
    const fields = ["maDeTai", "tenDeTai", "capDeTai", "ngayThucHien", "chuNhiem", "linhVuc"];
    const danhSachGiangVienHD=[{Name:"Mã Trường Thành", MSCB:"MSCB01"},{Name:"Trần Nguyễn Minh Thư", MSCB:"MSCB02"},{Name:"Võ Trí Thức", MSCB:"MSCB03"}]
    const danhSachLinhVuc = ["Y tế", "Giáo dục", "Giao thông", "Kinh tế", "Nông nghiệp", "Công nghiệp"]; // 1 data được lọc trong bảng
    ...
    function handleFilters(){
        console.log(giangVienHD);
        console.log(linhVuc);
        console.log("Đề tài cấp " + capDeTai);
        console.log(namBD);
        console.log(namKT);
    ...
    return (
        <>
            <div className="flex flex-col gap-2.5">
                <MyButton size="small" variant="none" className="self-end bg-buttonColor text-textColor1">Xuất danh sách</MyButton>
                <div className="flex gap-2.5 tableNavigation">
                    ...
                    <DropDown
                        ...
                        options={years}
                    ></DropDown>
                    <InputGiangVien fieldName={"Giảng Viên Hướng Dẫn"} users={danhSachGiangVienHD} giangVienHD={giangVienHD} setGiangVienHD={setGiangVienHD}></InputGiangVien>
                    <Search searchValue={searchValue} setSearchValue={setSearchValue}></Search>
                </div>
                <div className="flex gap-2.5">
                    <MyButton onClick={handleFilters} size="small" variant="none" className="bg-successColor text-textColor1">Xác Nhận</MyButton>
                    <MyButton onClick={clearFilters} size="small" variant="none" className="bg-warningColor text-textColor1">Huỷ</MyButton>
                </div>
            </div>
            <Table Theads={Theads} fields={fields} currentPage = {currentPage} renderAmount={Number(NofRowPerPage)} data={tableData}></Table>
            <Pagination
