...
export default function NavItem({navigateToTarget, fieldName}){
    ...
    const isActive = location.pathname === navigateToTarget;
    return(
        <button onClick={() => navigate(navigateToTarget)} className='my-2.5 group transition-all duration-300 naviButton relative'>
                ...
                : 
                <span className='rounded-md absolute w-full h-1 bg-primaryColor origin-bottom left-0 bottom-0 transition-all duration-300 text-white z-0'></span>
                }
